        ...
        <section id="container" class="">
            ...
            <section id="main-content">
                <section class="wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            <h3 class="page-header"><i class="fa fa-file-text-o"></i> Pencatatan Kategori Jadwal</h3>
                            <ol class="breadcrumb">
                                <li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
                                <li><i class="icon_document_alt"></i>Pencatatan</li>
                                <li><i class="fa fa-file-text-o"></i>Pencatatan jadwal</li>
                                <li><i class="fa fa-file-text-o"></i>Pencatatan Kategori Jadwal</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <section class="panel">
                                <header class="panel-heading">
                                    Pencatatan Kategori Jadwal
                                </header>
                                <div class="panel-body">

                                    {!! Form::open(['url' => '/inputkarjad', 'class' => 'form-horizontal']) !!}
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">ID Kategori Jadwal</label>
                                        <div class="col-sm-10">
                                            {!! Form::text('id_katjad', $id_katjad->MAX_ID_NUMBER, ['class' => 'form-control', 'readonly']) !!}
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Nama Kategori Jadwal</label>
                                        <div class="col-sm-10">
                                ...
                                <table class="table table-striped table-advance table-hover" style='table-layout: fixed'>
                                    <tbody>
                                        <tr>
                                            ...
                                            <th><i class="icon_profile"></i> ID Kategori Jadwal</th>
                                            <th><i class="icon_profile"></i> Nama Kategori Jadwal</th>
                                        ...
                                        @foreach ($kuy as $item)
                                            ...
                                            <tr>
                                                <td>{{ $no }}</td>
                                                <td>{{ $item->ID_KATJAD }}</td>
                                                <td>{{ $item->NAMA_KATJAD }}</td>
                                                <td>
                                                    <div class="btn-group">
                                                        <a class="btn btn-success"
                                                            href="editkarjad/{{ $item->ID_KATJAD }}"><i
                                                                class="icon_check_alt2"></i></a>
                                                        <a class="btn btn-danger"
                                                            href="hapuskarjad/{{ $item->ID_KATJAD }}"><i
