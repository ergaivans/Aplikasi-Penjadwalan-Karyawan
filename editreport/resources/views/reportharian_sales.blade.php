                                ...
                                <div class="padd">
                                    ...
                                    <div class="control-group after-add-more">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <select name="prospek[]" class="form-control m-bot15">
                                ...
                                <tbody>
                                    @foreach ($laporan as $data)
                                        <tr>
                                            ...
                                            <td>
                                            <th><a href="editreportharian/{{ $data->ID_LAPORAN }}"
                                                    class="btn btn-warning" style="margin-right: 8px">Edit</a><a
                                                    href="hapusreportharian/{{ $data->ID_LAPORAN }}"
                                                    class="btn btn-danger" style="margin-right: 8px">Hapus</a></th>
                                            </td>
