                        ...
                        <div class="col-lg-12">
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                    ...
                                    {!! Form::open(['url' => '/editprosestargetman', 'class' => 'form-horizontal']) !!}
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Tanggal Target</label>
                                        <div class="col-sm-10">
                                            {!! Form::date('tanggal', $kuy->TG, ['class' => 'form-control', 'readonly']) !!}
                                    ...
                                    <div class="col-lg-offset-2 col-lg-10">
                                        ...
                                        <a href="../validasitargetman" class="btn btn-danger"
