                        ...
                        <div class="col-lg-12">
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                    {!! Form::open(['url' => '/ubahstatuskaryawan', 'class' => 'form-horizontal']) !!}
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Bertanggung Jawab Kepada</label>
                                        <div class="col-sm-10">
                                            <select name="id_karyawan_up" class="form-control m-bot15">
                                                @foreach ($kuy as $data)
