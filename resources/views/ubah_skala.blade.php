        ...
        <section id="container" class="">
            <section id="main-content">
                <section class="wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            <h3 class="page-header"><i class="icon_datareport"></i> Ubah Parameter Penilaian</h3>
                            <ol class="breadcrumb">
                                ...
                                <li><i class=""></i>Ubah Parameter Penilaian</li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12">
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                    {!! Form::open(['url' => '/editskala', 'class' => 'form-horizontal']) !!}
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">ID Parameter</label>
                                        <div class="col-sm-10">
                                            {!! Form::text('id_skala', $edit->ID_SKALA, ['class' => 'form-control', 'readonly']) !!}
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Parameter Atas</label>
                                        <div class="col-sm-10">
                                            {!! Form::text('skala_atas', $edit->SKALA_ATAS, ['class' => 'form-control']) !!}
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Parameter Bawah</label>
                                        <div class="col-sm-10">
                                            {!! Form::text('skala_bawah', $edit->SKALA_BAWAH, ['class' => 'form-control']) !!}
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Keterangan</label>
                                        <div class="col-sm-10">
                                            {!! Form::text('ket_skala', $edit->KET_SKALA, ['class' => 'form-control']) !!}
                                        </div>
                                    </div>
                                    <div class="col-lg-offset-2 col-lg-10">
                                        <button class="btn btn-primary" type="submit">Simpan</button>
                                        <a href="../parameter-penilaian" class="btn btn-danger"
