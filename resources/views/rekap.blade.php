                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li><i class=""></i>Rekap Penilaian</li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12">
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                    {!! Form::open(['url' => '/rekap-penilaian', 'class' => 'form-horizontal']) !!}
                                    {{-- <div class="form-group">
                                        <label class="col-sm-2 control-label">ID Rekap</label>
                                        <div class="col-sm-10">
                                    ...
                                    {{-- <div class="form-group">
                                        <label class="control-label col-lg-2" for="inputSuccess">Tanggal Awal</label>
                                        <div class="col-lg-10">
                                            {!! Form::date('tanggal', null, ['class' => 'form-control', 'required']) !!}
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-lg-2" for="inputSuccess">Tanggal Akhir</label>
                                        <div class="col-lg-10">
                                            {!! Form::text('tanggal', null, ['class' => 'form-control', 'required']) !!}
                                        </div>
                                    </div> --}}
                                    <div class="form-group">
                                        <label class="control-label col-lg-2" for="inputSuccess">Closing Sales</label>
                                        <div class="col-lg-10">
                                            @foreach ($ku as $data)
                                                <option value="{{ $data->CLOSING }}"> {{ $data->REALISASI_JML_UNIT }}>
                                                </option>
                                            @endforeach
                                        </div>
                                    </div>
                                    {{-- <div class="form-group">
                                        <label class="control-label col-lg-2" for="inputSuccess">Closing Agent</label>
                                        <div class="col-lg-10">
                                            {!! Form::text('tanggal', null, ['class' => 'form-control', 'required']) !!}
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-lg-2" for="inputSuccess">Walk in</label>
                                        <div class="col-lg-10">
                                            {!! Form::text('tanggal', null, ['class' => 'form-control', 'required']) !!}
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-lg-2" for="inputSuccess">Database Cust.</label>
                                        <div class="col-lg-10">
                                            {!! Form::text('tanggal', null, ['class' => 'form-control', 'required']) !!}
                                        </div>
                                    </div> --}}
