        ...
        <section id="container" class="">
            <section id="main-content">
                <section class="wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            <h3 class="page-header"><i class="icon_clipboard"></i> Kategori Penilaian</h3>
                            <ol class="breadcrumb">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($kuy as $item)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $item->TARGET_KATEGORI }}</td>
                                                {{-- <td>{{ $item->SCORE_KATEGORI }}</td> --}}
                                                <td>
                                                    <div class="btn-group">
                                                        <a class="btn btn-default btn-m buttonLila" href="#"
                                                            data-toggle="modal"
                                                            data-peler='{{ $item->KETERANGAN_KATEGORI }}'
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a class="btn btn-success"
                                                            href="ubah_kategori/{{ $item->ID_KATEGORI }}"><i
                        ...
                        <div class="col-lg-12">
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                    {!! Form::open(['url' => '/tambahkategori', 'class' => 'form-horizontal']) !!}
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">ID Kategori</label>
                                        <div class="col-sm-10">
                                            {!! Form::text('id_kategori', $id_kategori->MAX_ID_NUMBER, ['class' => 'form-control', 'readonly']) !!}
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            {!! Form::text('target_kategori', null, ['class' => 'form-control', 'required']) !!}
                                        </div>
                                    </div>
                                    {{-- <div class="form-group">
                                        <label class="col-sm-2 control-label">Score Kategori</label>
                                        <div class="col-sm-10">
                                            {!! Form::number('score', null, ['class' => 'form-control', 'min' => '0', 'required']) !!}
                                        </div>
                                    </div> --}}
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Keterangan</label>
                                        <div class="col-sm-10">
                                            {!! Form::number('keterangan_kategori', null, ['class' => 'form-control', 'required']) !!}
                                        </div>
                                    </div>
