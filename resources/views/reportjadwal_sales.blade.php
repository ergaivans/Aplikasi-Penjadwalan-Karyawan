                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li><a href="view_report_sales">Report Terjadwal</a></li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-md-12 portlets">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <div class="pull-left">Form Report</div>
                            ...
                            <div class="panel-body">
                                <div class="padd">
                                    ...
                                    {!! Form::open(['url' => '/proses_reportjadwal_sales', 'class' => 'form-horizontal']) !!}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            {!! Form::text('kegiatan', $jadwal->JADWAL, ['class' => 'form-control', 'placeholder' => 'Kegiatan', 'readonly']) !!}
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Realisasi</label>
                                        <div class="col-sm-10">
                                            <select name="jenis" class="form-control m-bot15" autofocus>
                                                @foreach ($kat_jad as $item)
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            {!! Form::date('tanggal', $jadwal->TANGGAL, ['class' => 'form-control', 'placeholder' => 'Tanggal Kegiatan', 'readonly']) !!}
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Keterangan</label>
                                        <div class="col-sm-10">
                                            {!! Form::textarea('keterangan', null, ['class' => 'form-control', 'placeholder' => 'Keterangan Kegiatan']) !!}
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        @if ($jadwal->JADWAL == 'Kantor')
                                            ...
                                            <div class="col-sm-10">
                                                <select name="kehadiran" class="form-control m-bot15">
                                                    ...
                                                    <option value="0">Tidak Kantor</option>
                                                </select>
                                            </div>
                                        @else
                                            <label class="col-sm-2 control-label">Walk in</label>
