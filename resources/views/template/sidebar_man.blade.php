        ...
        <aside>
            <div id="sidebar" class="nav-collapse">
                ...
                <ul class="sidebar-menu">
                    <li>
                        <a class="" href="/project_prospero/index_mana">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a class="" href=" /project_prospero/monitorjadwalman">Monitoring
                                    Jadwal</a>
                            </li>
                            <li><a class="" href="/project_prospero/monitoringlaporanman">Monitoring
                                    Laporan</a></li>
                            <li><a class="" href="/project_prospero/monitoringcustman">Monitoring
                                    Customer</a></li>
                        </ul>
                    </li>
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a class="" href=" /project_prospero/validasitargetman">Pencatatan
                                    Target</a>
                            </li>
                            <li><a class="" href="/project_prospero/pencatatan_man">Pencatatan
                                    Karyawan</a></li>
                        </ul>
                    </li>
                </ul>
