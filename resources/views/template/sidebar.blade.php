...
<body class="body1">
    ...
    <section id="container" class="">
        ...
        <header class="header dark-bg col-xs-12 col-md-12">
            ...
            <!--logo start-->
            <a href="index_admin" class="logo"><b>Prospero </b><span class="lite">Marketing
                    Apps</span></a>
            <!--logo end-->
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar"
                                            src="resources//img/avatar-mini4.jpg"></span>
                                    <span class="subject">
        ...
        <aside>
            <div id="sidebar" class="nav-collapse">
                ...
                <ul class="sidebar-menu">
                    <li>
                        <a class="" href="/project_prospero/index_admin">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a class="" href="/project_prospero/pencatatan">Pencatatan Karyawan</a>
                            </li>
                            <li><a class="" href="/project_prospero/catattarget">Pencatatan Target</a>
                            </li>
                            <li><a class="" href="/project_prospero/targetsales">Pencatatan Target
                                    Sales</a>
                            </li>
                            <li><a class="" href="/project_prospero/kriteriabisa">Pencatatan Kriteria</a>
                            </li>
                            <li><a class="" href="/project_prospero/penjadwalanbisa">Penjadwalan
                                    Sales</a>
                            </li>
                            <li><a class="" href="/project_prospero/penjadwalanpameran">Penjadwalan
                                    Pameran</a>
                            </li>
                        </ul>
                    </li>
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a class="" href=" /project_prospero/monitorjadwal">Monitoring Jadwal</a>
                            </li>
                            <li><a class="" href="/project_prospero/monitoringlaporan">Monitoring
                                    Laporan</a></li>
                            <li><a class="" href="/project_prospero/monitoringcust">Monitoring
                                    Customer</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a class="" href="/project_prospero/periode-penilaian">Periode
                                    Penilaian</a></li>
                            <li><a class="" href="/project_prospero/kategori-penilaian">Kategori
                                    Penilaian</a></li>
                            <li><a class="" href="/project_prospero/parameter-penilaian">Parameter
                                    Penilaian</a>
                            </li>
                            {{-- <li><a class="" href="/project_prospero/agent-under">Agent Under</a></li> --}}
                        </ul>
                    </li>
                </ul>
                <!-- sidebar menu end-->
