                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            Tabel Ubah Pencatatan Karyawan
                        </header>
                        <div class="panel-body">
                            <div class="form">
                                {!! Form::open(['url' => '/masukineditkaryawanman', 'class' => 'form-validate form-horizontal', 'id' => 'register_form']) !!}
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        {!! Form::text('nama_karyawan', $edit->NAMA_KARYAWAN, ['class' => 'form-control', 'required']) !!}
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        {!! Form::text('no_tlp', $edit->NO_TLP, ['class' => 'form-control', 'required']) !!}
                                        {{-- <input class=" form-control" id="address" name="address" type="text" /> --}}
                                    </div>
                                </div>
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        {!! Form::text('ttl', $edit->TTL, ['class' => 'form-control', 'required']) !!}
                                        {{-- <input class=" form-control" id="address" name="address" type="text" /> --}}
                                    </div>
                                </div>
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        {!! Form::text('alamat', $edit->ALAMAT, ['class' => 'form-control', 'required']) !!}
                                        {{-- <input class=" form-control" id="address" name="address" type="text" /> --}}
                                    </div>
                                </div>
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        ...
                                        {!! Form::text('jabatan', $edit->JABATAN, ['class' => 'form-control', 'required']) !!}
                                        {{-- <input class=" form-control" id="address" name="address" type="text" /> --}}
                                    </div>
                                </div>
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        {!! Form::text('email', $edit->EMAIL, ['class' => 'form-control', 'required']) !!}
                                        {{-- <input class=" form-control" id="address" name="address" type="text" /> --}}
                                    </div>
                                </div>
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        {!! Form::text('id_user', $edit->ID_USER, ['class' => 'form-control', 'required']) !!}
                                        {{-- <input class=" form-control" id="address" name="address" type="text" /> --}}
                                    </div>
                                </div>
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        {!! Form::text('password', $edit->PASSWORD, ['class' => 'form-control', 'required']) !!}
                                        {{-- <input class=" form-control" id="address" name="address" type="text" /> --}}
                                    </div>
                                </div>
                                <div class="form-group ">
