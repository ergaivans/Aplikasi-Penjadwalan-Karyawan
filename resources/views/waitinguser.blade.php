...
@section('content')
    ...
    <section id="main-content">
        <section class="wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-table"></i>Permintaan Persetujuan</h3>
                    <ol class="breadcrumb">
                        ...
                        <li><i class=""></i>Permintaan Persetujuan</li>
                    </ol>
                </div>
            </div>
                        ...
                        <table class="table table-striped table-advance table-hover" style='table-layout: fixed'>
                            <tbody>
                                <tr>
                                    ...
                                    <th><i class=""></i>Bendera</th>
                                    <th><i class=""></i>Permintaan</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <a class="btn btn-danger" href="hapusakun/{{ $item->ID_KARYAWAN }}"><i
