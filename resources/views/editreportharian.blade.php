                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li><i class=""></i>Ubah Monitoring Laporan</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                    ...
                                    {!! Form::open(['url' => '/proseseditreport', 'class' => 'form-horizontal']) !!}
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">ID Laporan</label>
                                        <div class="col-sm-10">
                                            {!! Form::text('id_report', $laporan->ID_LAPORAN, ['class' => 'form-control', 'readonly']) !!}
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">ID Laporan</label>
                                        <div class="col-sm-10">
                                            {!! Form::text('id_report', $laporan->ID_KARYAWAN, ['class' => 'form-control', 'readonly']) !!}
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Nama Sales</label>
                                        <div class="col-sm-10">
                                            {!! Form::text('nama', $laporan->NAMA_KARYAWAN, ['class' => 'form-control']) !!}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            {!! Form::text('tanggal', $laporan->TANGGAL_LAPORAN, ['class' => 'form-control']) !!}
                                            {{-- <input type="text" class="form-control"> --}}
                                        </div>
                                    </div>
                                    <div class="form-group">
