        ...
        <section id="container" class="">
            ...
            <section id="main-content">
                <section class="wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            <h3 class="page-header"><i class="fa fa-table"></i>Tambah Kategori Penjadwalan</h3>
                            <ol class="breadcrumb">
                                <li><i class="fa fa-home"></i><a href="index_admin">Halaman Utama</a></li>
                                <li><i class=""></i>Pencatatan</li>
                                <li><i class=""></i>Penjadwalan Karyawan</li>
                                <li><i class=""></i>Tambah Kategori Penjadwalan</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <section class="panel">
                                <header class="panel-heading">
                                    Form Tambah Kategori Penjadwalan
                                </header>
                                        ...
                                        @foreach ($kuy as $item)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-success"
                                                        href="editkaryawanbisa/{{ $item->ID_KATJAD }}"><i
                                                            class="icon_pencil-edit"></i>
                                                        Ubah</a>
                                                    <a class="btn btn-danger"
                                                        href="editkaryawanbisa/{{ $item->ID_KATJAD }}"><i
                                                            class="icon_pencil-edit" style="margin-left: 5px"></i>
                                                        hapus</a>
                                                </td>
                                            </tr>
