                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li><i class="fa fa-file-text-o"></i>Update Validasi Customer</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            {!! Form::text('nominal', $valid->NOMINAL, ['class' => 'form-control', 'readonly']) !!}
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            {!! Form::text('rl_unit', $valid->REALISASI_UNIT, ['class' => 'form-control']) !!}
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Realisasi Jumlah Unit </label>
                                        <div class="col-sm-10">
                                            {!! Form::text('rl_jml', $valid->REALISASI_JML_UNIT, ['class' => 'form-control']) !!}
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Realisasi Nominal</label>
                                        <div class="col-sm-10">
                                            {!! Form::text('rl_nom', $valid->REALISASI_NOMINAL, ['class' => 'form-control']) !!}
                                        </div>
