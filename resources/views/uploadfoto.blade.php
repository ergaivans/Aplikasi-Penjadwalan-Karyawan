                                ...
                                <div class="panel-body">
                                    <form action="{{ route('fileUpload') }}" method="post" enctype="multipart/form-data"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" readonly name="ID_LAPORAN" class="form-control"
                                                    id="id_laporan" value={{ $laporan->ID_LAPORAN }}>
                                            </div>
                                        </div>
                                        <div class="form-group">
    ...
    <div class="container mt-5">
        <form action="{{ route('fileUpload') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="custom-file">
                <input type="text" name="ID_LAPORAN" value={{ $laporan->ID_LAPORAN }} class="custom-file-input"
                    id="id_laporan">
