                    ...
                    <div class="col-lg-12">
                        ...
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <!-- tanggal -->
                                {!! Form::open(['url' => '/monitorjadwalman/filtermonitortanggaljadwalman', 'id' => 'form_tanggal_filter', 'class' => 'form-inline', 'style' => 'margin-top:12px']) !!}
                                <div class="col-lg-3">
