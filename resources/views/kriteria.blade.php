        ...
        <section id="container" class="">
            ...
            <section id="main-content">
                <section class="wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            <h3 class="page-header"><i class="fa fa-table"></i>Pencatatan Kriteria</h3>
                            <ol class="breadcrumb">
                                <li><i class="fa fa-home"></i><a href="index_admin">Halaman Utama</a></li>
                                <li><i class=""></i>Pencatatan</li>
                                <li><i class=""></i>Pencatatan Kriteria</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            {!! Form::text('nama_kriteria', null, ['class' => 'form-control', 'required']) !!}
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Nilai Kriteria</label>
                                        <div class="col-sm-10">
                                            <select name="nilai" class="form-control m-bot15">
                                                <option value="0">Prospek</option>
                            ...
                            <section class="panel">
                                ...
                                <table class="table table-striped table-advance table-hover" style='table-layout: fixed'>
                                    <tbody>
                                        <tr>
                                            <th><i class=""></i>No</th>
                                            <th><i class=""></i>ID Kriteria</th>
                                            <th><i class=""></i>Nama Kriteria</th>
                                            <th><i class=""></i>Kategori Kriteria</th>
                                        ...
                                        @foreach ($kuy as $item)
                                            ...
                                            <tr>
                                                ...
                                                @if ($item->TIPE_KRITERIA == '1')
                                                    <td>Prospek</td>

                                                @elseif ($item->TIPE_KRITERIA == '2')
                                                    <td>Hot Prospek</td>
                                                @endif
