                        ...
                        <div class="col-lg-12">
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                    {!! Form::open(['url' => '/masukintinjaucus2', 'class' => 'form-horizontal']) !!}
                                    {!! Form::hidden('id_dc', $id_dc->MAX_ID_NUMBER) !!}
                                    {!! Form::hidden('id_laporan', $customer->ID_LAPORAN) !!}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select name="tower" class="form-control m-bot15">
                                                <option value="Fortuna">Fortuna
                                                </option>
                                                <option value="Beatus">Beatus
                                                </option>
                                            </select>
                                            <!-- {!! Form::text('tower', null, ['class' => 'form-control', 'id' => 'inputTower', 'autofocus']) !!} -->
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            {!! Form::text('ket_unit', null, ['class' => 'form-control', 'placeholder' => 'Keterangan Unit(No.Unit)']) !!}
                                        </div>
                                    </div>
                                    <div class="form-group">
