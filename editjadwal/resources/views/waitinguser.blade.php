...
@section('content')
            ...
            <section id="main-content">
                <section class="wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            <h3 class="page-header"><i class="fa fa-table"></i> Validasi Akses</h3>
                            <ol class="breadcrumb">
                                <li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
                                <li><i class="fa fa-table"></i>Pencatatan</li>
                                <li><i class="fa fa-th-list"></i>Validasi Akses</li>
                            </ol>
                        </div>
                    </div>
                                    ...
                                    @endphp
                                        @foreach ($daftar as $item)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a class="btn btn-success" href="ubahstatuskaryawan/{{$item->ID_KARYAWAN}}"><i class="icon_check_alt2"></i></a>
                                                        <a class="btn btn-danger" href="hapusakun/{{$item->ID_KARYAWAN}}"><i class="icon_close_alt2"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
